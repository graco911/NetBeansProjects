...
public class DPO1_U4_A1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            System.out.println("7.- Mostrar productos ordenados de mayor a menor");
            System.out.println("8.- Mostrar productos ordenados de menor a mayor");
                ...
                case 7:
                    Productos.getProductos().stream().map(d 
                            -> "Clave " + d.getClave() + 
                                    "\n Nombre " + d.getNombre() +
                                    "\n Precio " + d.getPrecio() +
                                    "\n Cantidad " + d.getCantidad()).sorted(Comparator.naturalOrder()).forEach(System.out::println);
                    break;
                case 8:
                    break;
            }    
