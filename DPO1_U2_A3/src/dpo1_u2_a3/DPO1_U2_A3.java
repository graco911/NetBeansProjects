...
public class DPO1_U2_A3 {
            ...
            switch(opcion){
                ...
                float sueldo = 0;
                    if (Empleados.isEmpty()) {
                        ...
                        CalcularDescuentoFaltas(empleado);
                        CalularAguinaldo(empleado);
                        CalcularBonoExtra(empleado);
                    }
                    break;
                case 2:
                    ...
                    int anios;
                    //SOLICITAR AL USUARIO EL NUMERO DE EMPLEADOS A INGRESAR
    ...
    private static void CalcularDescuentoFaltas(Empleado empleado) {
        float descuento = (empleado.getSueldo_neto() * .15f) * empleado.getFaltas();
        System.out.println("El descuento al empleado es: "  + descuento);
    }

    private static void CalularAguinaldo(Empleado empleado) {
        float aguinaldo = 800 * 40;
        empleado.setAguinaldo(aguinaldo);
        System.out.println("El aquinaldo del empleado es: "  + aguinaldo);
    }

    private static void CalcularBonoExtra(Empleado empleado) {
        float bono = (empleado.getAguinaldo() * 0.5f) * empleado.getAnios_antiguedad();
        System.out.println("El bono extra del empleado es: "  + bono);
    }
}
